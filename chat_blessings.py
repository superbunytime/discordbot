...
blessings_list = ["good luck in conversation", "easier access to flow state", "critical success on your next crafting roll","enhanced power level detection","the 'detect wood quality' buff","increased likelihood of leaving a good first impression","flirting skills up","+20% magic find","increased moisture duration","+0.5% size","an inventory UI that's shaped a little bit more like a smiley face","more","your phone being in the first pocket you check","+10% to perception checks relating to zenzi","you can now sense rabbits within a 50 foot radius","a mental image of a cute rabbit","5% increase to gay","+1 pronoun slot (empty)"," 100 rats now follow your command...somewhere!","+0.1% soul attunement (permanent, stacking); with cooldown on next bless", "+2% butt fat","+1% damage with axe class weapons","you can remember 1 more sequential number",f"+{rand(list(range(1, 101)))}% chance of inflicting {rand(good_effects)}"]
