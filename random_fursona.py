...
species_list = ["bird", "dog", "bunny", "cat", "avali", "hare", "protogen", "moth", "salamander", "chimera", "bat", "cow", "wolf", "fox", "coyote", "sheep", "goat", "deer", "dragon", "wyvern", "spider", "horse", "lion", "tiger", "bear", "shark",
                "hyena", "bee", "lamia", "kangaroo", "possum", "wombat", "skunk", "slug", "sea slug", "moogle", "ferret", "weasel", "stoat", "otter", "dryad", "raccoon", "alligator", "crocodile", "snake", "rat", "mouse", "chipmunk", "squirrel", "fennec", "kitsune", "puma", "little pee pee boy", "pangolin", "mamagen"]
...
size_list = ["thimble-sized", "cup full of", "small", "medium", "large", "micro",
             "macro", "subatomic", "galactic", "dumptruck of a", "brick wall of a", "four course meal", "five-dimensional", "dimensionally-inconceivable", "insignificant dust-speck sized"]
...
role_list = ["healer", "tank", "mage", "bard", "dps", "support", "alchemist", "knight",
             "deadbeat", "merchant", "diplomat", "rogue", "druid", "necromancer", "nekomancer", "geomancer", "seer", "hardass", "emergency food supply", "freeloader", "milk drinker", "imposter", "crewmate", "idol", "mime", "chef"]
