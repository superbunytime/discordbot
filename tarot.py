...
"""TODO
  Add multi card draw variables
  either in new functions, randomly, or as an argument passed to ?tarot.
  in order to do it in the most user-intuitive way, make it so the command can accept an argument
  but still functions on an empty string. Also limit the argument to the logical high value of 
  drawn tarot cards, which i think is 10."""
